...
class BlockchainTestSuite:
    def __init__(self, repeat_count=10, block_size=2, difficulty=1):
        self.algorithms = algorithms = ['Falcon-512', 'Falcon-1024', 'Dilithium2', 'Dilithium3', 'Dilithium5', 'SPHINCS+-SHA2-256f-simple', 'SPHINCS+-SHA2-256s-simple']
        self.results = {
            "public_key_size": {},
            "private_key_size": {},
            "signature_size": {},
        ...
        for algorithm in self.algorithms:
            provider = cryptography.CryptoProvider(algorithm,'sha512')
    ...
    def display_results(self):
        self.plot_results("Public Key Size", self.results["public_key_size"], "publc_key_size", "Size (bytes)")
