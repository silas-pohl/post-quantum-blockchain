...
algorithms = ['Falcon-512', 'Falcon-1024', 'Dilithium2', 'Dilithium3', 'Dilithium5', 'SPHINCS+-SHA2-256f-simple', 'SPHINCS+-SHA2-256s-simple']

for algorithm in cryptography.SUPPORTED_SIGNATURE_ALGORITHMS:

    print(f"Blockchain with {algorithm}")

    crypto_provider = cryptography.CryptoProvider(algorithm,'sha512')
    public_key1, private_key1 = crypto_provider.generate_keypair()
    ...
    public_key2, private_key2 = crypto_provider.generate_keypair()
